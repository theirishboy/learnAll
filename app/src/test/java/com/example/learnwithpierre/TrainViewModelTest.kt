...
class TestDataRepository : DataRepository {
    private val testData: List<Data> = listOf(
        Data(1, "demo1", "vide1", false, "animal1", 1, LocalDateTime.now()),
        Data(2, "demo2", "vide2", false, "animal2", 2, LocalDateTime.now())
    )

    override fun getAllDataStream(): Flow<MutableList<Data>> {
        // Implement this method if needed for your tests
        TODO()
    }

    override fun getDataStream(id: Int): Flow<Data?> {
        // Implement this method if needed for your tests
        TODO()
    }
    ...
    override fun getRandomData(): Flow<List<Data>> {
...
class TrainViewModelTest {
    ...
    fun trainViewModel_CorrectScoreCalculation() = runBlocking {
        ...
        trainUiState.dataList = mutableListOf(item1, item2) // Use mutableListOf() to create a mutable list
        ...
        assertEquals(trainUiState.dataList.last(), item1)
    ...
    fun trainViewModel_PopUpState_CompareData_GoodAnswer() = runBlocking {
        ...
        trainUiState.dataList.last().verso = "Good answer"
        val showAnswerState = viewModel.showAnswerPopUp
    ...
    fun trainViewModel_PopUpState_CompareData_BadAnswer() = runBlocking {
        ...
        trainUiState.dataList.last().verso = "Badanswer"
